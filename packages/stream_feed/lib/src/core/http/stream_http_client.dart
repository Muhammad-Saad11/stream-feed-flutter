...
class StreamHttpClient {
  ...
  StreamHttpClient(
    ...
    Logger? logger,
        ...
        httpClient = dio ?? Dio() {
    httpClient
      ..options.receiveTimeout = this.options.receiveTimeout.inMilliseconds as Duration?
      ..options.connectTimeout = this.options.connectTimeout.inMilliseconds as Duration?
